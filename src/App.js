    ...
    return (
        <div className="App">
            <header className='App-header'>
                ...
                <ul className="menu">
                    <li><a href="default.asp">IPHONE</a></li>
                    <li><a href="news.asp">SAMSUNG</a></li>
                    <li><a href="contact.asp">ETC..</a></li>
                </ul>
                <img className='app-header-logo' src="/images/logoo.png" alt="Logo" />
                <li className='coll'><a href="contact.asp">COLLECTIONS</a></li>
            ...
            <div className='main-content'>
                ...
                <div className='phone-image'>
                    <img className='iphone15' src='/images/iphone15.png' alt="iPhone 15" />
                </div>
